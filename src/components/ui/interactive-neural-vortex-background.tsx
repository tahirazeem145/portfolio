  ...
  useEffect(() => {
    ...
    const fsSource = `
      ...
      void main() {
        ...
        color = vec3(0.03, 0.05, 0.16);
        color = mix(color, vec3(0.05, 0.55, 0.85), 0.32 + 0.16 * sin(2.0 * u_scroll_progress + 1.2));
        color += vec3(0.25, 0.12, 0.6) * sin(2.0 * u_scroll_progress + 1.5);
        color = color * noise;
    ...
    const render = () => {
      ...
      gl.uniform1f(uTime, performance.now() % 3600000.0);
      gl.uniform2f(
        uPointerPosition,
