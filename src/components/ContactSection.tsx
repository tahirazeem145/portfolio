    ...
    <section id="contact" ref={sectionRef} className="py-24 relative z-10 border-t border-white/10 bg-black/50">
      <div className="max-w-4xl mx-auto px-6 w-full text-center">
        ...
        <div className="contact-reveal flex flex-wrap justify-center gap-6 mb-16">
          <a href="mailto:tahirazeems145s@gmail.com" className="flex items-center gap-3 px-6 py-4 glass rounded-full hover:-translate-y-1 transition-transform group">
          ...
          <a href="https://www.linkedin.com/in/tahirazeem-r" target="_blank" rel="noreferrer" className="flex items-center gap-3 px-6 py-4 glass rounded-full hover:-translate-y-1 transition-transform group">
          ...
          <a href="https://github.com/tahirazeem145" target="_blank" rel="noreferrer" className="flex items-center gap-3 px-6 py-4 glass rounded-full hover:-translate-y-1 transition-transform group">
